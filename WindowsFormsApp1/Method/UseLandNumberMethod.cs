...
{
    public class UsePlanNumberMethod<T> : AttributeBaseMethod<T> where T : UseLandNumberModel
    {
        private UsePlanNumberMethod() { }
        public UsePlanNumberMethod(T model) : base(model)
        {
