            ...
            { 
                ...
                using (Transaction acTrans = db.TransactionManager.StartTransaction())
                {
                    ...
                    for (int j = 0; j < idArray.Length; j++)
                    {
                        ...
                        // 找一个参照物——主导功能
                        if (ent2 is MText && ((MText)ent2).Text == "主导功能")
                        {
                            for (int z = 0; z < idArray.Length; z++)
                            {
                                ...
                                if (ent3 is MText && ((MText)ent2).Location.X - 50 < ((MText)ent3).Location.X && ((MText)ent3).Location.X < ((MText)ent2).Location.Y + 50 && ((MText)ent2).Location.Y >= ((MText)ent3).Location.Y)
                                {
