...
{
    public class ReadDanAttributeList
    {
        ...
        public System.Data.DataTable AttributeList()
        {
            ...
            PromptResult pr = ed.GetString("用地代码");
        ...
        public System.Data.DataTable ControlList()
        {
            Document doc = Autodesk.AutoCAD.ApplicationServices.Application.DocumentManager.MdiActiveDocument;
            Editor ed = doc.Editor;
            Database db = doc.Database;
            PromptResult pr = ed.GetString("控制要求");
            ...
            // 增加一个规划控制要求dataTable
            System.Data.DataTable table2 = new System.Data.DataTable("控制要求");
