    ...
    public class FenTuZe
    {
        public void SendData(System.Data.DataTable table)
        {
            ...
            using (Transaction tr = db.TransactionManager.StartTransaction())
            {
                ...
                DrawBorder(resultAll, tr, btr, 5, ed, table);
        ...
        public static void DrawBorder(ArrayList polylines, Transaction trans, BlockTableRecord btr, int numSample, Editor ed, System.Data.DataTable table)
        {
            ...
            foreach (Polyline polyline in polylines)
            {
                ...
                for (int i = 0; i < loopNum; i++)
                {
                    ...
                    foreach (Point2d point in col_point2d)
                    {
                        ...
                        * D * D * D * D / 120) / Math.Cos(fai);
                        ...
                        //// 现状图
                        //output[0] = longitude1 / iPI + 108.7271360867638 + 0.0002173 - 11 + 0.00061422 - 0.000396;
                ...
                // 用地构成表主键
                DataRow[] foundRows;
                foundRows = table.Select("用地代码='R'");
                for (int i = 0; i < foundRows.Length; i++)
                {
                    attributeListPrimary.Add(foundRows[i][0]);
                }
            ...
            string attributeListPrimaryString = string.Empty;
            attributeListPrimaryString = JsonConvert.SerializeObject(attributeListPrimary);
            ...
            attributeListString = JsonConvert.SerializeObject(table);

            result.Add("geom", geomString);
            result.Add("attrlist", attrlistString);
            result.Add("attributeListPrimary", attributeListPrimaryString);
            ...
            //    string resString;
            //    byte[] reqString;
            //    var baseAddress = "http://172.18.84.97:8080/CIM/cim/cim-interface!";
            //    try
            //    {
            //        webClient.Headers["content-type"] = "application/json";
            //        reqString = Encoding.Default.GetBytes(JsonConvert.SerializeObject(JSONString, Formatting.Indented));
            //        resByte = webClient.UploadData(baseAddress, "post", reqString);
            ...
            // 发送 开始
            var baseAddress = "http://172.18.84.102:8080/CIM/cim/geom!addCadGeomByType.action";
